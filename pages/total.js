      ...
      <form onSubmit={colocarOrden}>
        ...
        <div className="mt-5">
          <input
            ...
            className={`w-full lg:w-auto px-5 py-2 rounded uppercase font-bold text-white text-center ${comprobarPedido() ? "bg-indigo-300" : "bg-indigo-600"} hover:bg-indigo-800 cursor-pointer`}
          />
        </div>
      </form>
    </Layout>
